...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Tambah Platform</h1>
            <p class="text-sm text-slate-500">Tambahkan platform baru untuk katalog game.</p>
        </div>
    ...
    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action="{{ route('admin.platforms.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="rounded-full bg-cyan-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-cyan-500">Simpan Platform</button>
            </div>
        </form>
    </div>
</div>
